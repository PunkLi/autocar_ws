...
{
  uint8_t sof;
  int16_t angle;  // car angle
  int16_t v_w;    // steering speed
  int16_t v_x;    // advance speed
  int16_t v_y;    // translation speed


  uint8_t flag;   // usb flag
  uint32_t x;
  uint32_t y;
  uint32_t z;
  uint32_t compass;
  ...
  float pan_title_yaw;    // PTZ yaw
  float pan_title_pitch;  // PTZ pitch
  uint8_t end;
